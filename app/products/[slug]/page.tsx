...
export async function generateStaticParams() {
    ...
    const { data: posts } = await supabase.from('easy-sell-products').select('id');
    if (!posts) {
      return [];
    }
            ...
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 mb-4">
                <div className="flex items-center justify-center">
                    <Image
                        ...
                        height={600}
                        alt={data.name}
                        src={`https://rueqqiubulvuiwhfhjcd.supabase.co/storage/v1/object/public/storage/${data.imageUrl}`}
                    />
                </div>
